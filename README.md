...
**High Risk F1 of 0.98 on 1,425 real test samples** — not synthetic. The model correctly identifies critical conditions with high recall, minimising the missed detections that matter most in a maintenance context.
